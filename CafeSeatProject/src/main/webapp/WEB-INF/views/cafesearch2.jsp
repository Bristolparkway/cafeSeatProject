		...
		<!-- Wrapper-->
			<div id="wrapper">
				...
				<!-- Main -->
					...
					<!-- Aside -->
						<aside id="aside">
						<a href="#" class="icon solid fa-home"><span>자리 연장</span></a>
						<a href="#work" class="icon solid fa-folder"><span>자리 이동</span></a>
						<a href="#contact" class="icon solid fa-envelope"><span>이용 종료</span></a>
						</aside>
